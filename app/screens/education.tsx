...
const FEATURED_ARTICLES = [
  {
    ...
    summary:
      "Learn about the basics of epilepsy in children and how it differs from adult epilepsy.",
    imageUrl:
      "https://api.a0.dev/assets/image?text=Understanding%20Pediatric%20Epilepsy&aspect=16:9",
    readTime: "5 min read",
    category: "Basics",
  },
  {
    ...
    summary:
      "Essential steps every parent should know when their child has a seizure.",
    imageUrl:
      "https://api.a0.dev/assets/image?text=Seizure%20First%20Aid&aspect=16:9",
    readTime: "4 min read",
    category: "First Aid",
  },
  {
    ...
    summary:
      "Common side effects of anti-seizure medications and when to contact your doctor.",
    imageUrl:
      "https://api.a0.dev/assets/image?text=Medication%20Side%20Effects&aspect=16:9",
    readTime: "7 min read",
...
const RECENT_ARTICLES = [
  {
    ...
    summary:
      "How to work with schools to ensure your child gets proper support and accommodations.",
    imageUrl:
      "https://api.a0.dev/assets/image?text=School%20Accommodations&aspect=16:9",
    readTime: "6 min read",
    category: "School",
  },
  {
    ...
    summary:
      "The important relationship between sleep quality and seizure control in children.",
    imageUrl:
      "https://api.a0.dev/assets/image?text=Sleep%20and%20Seizures&aspect=16:9",
    readTime: "5 min read",
    category: "Lifestyle",
  },
  {
    ...
    summary:
      "Recent advances in treating childhood epilepsy and promising research directions.",
  ...
  const renderArticleCard = (article, isFeatured = false) => (
    ...
    >
      ...
      <View className="p-4">
        ...
        <Text
          className={`${isFeatured ? "text-xl" : "text-lg"} font-bold text-slate-800 mb-2`}
        >
          {article.title}
        </Text>
        {isFeatured && (
        ...
        <View className="mb-6">
          <View className="bg-white rounded-xl p-4 shadow-sm">
            <View className="flex-row items-center mb-4">
              ...
              <Text className="text-2xl font-bold text-green-600 ml-3">
                Safety Tips
              </Text>
            </View>
            ...
            <View className="mb-4">
              ...
              <View className="flex-row items-start mb-4">
                <Ionicons name="checkmark-circle" size={24} color="#27AE60" />
                <Text className="text-lg text-slate-800 ml-3 flex-1 leading-6">
                  Use shower seats and avoid bathtubs for children with frequent
                  seizures
                </Text>
              </View>
