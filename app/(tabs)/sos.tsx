...
export default function EmergencyScreen() {
  ...
  const handleOpenInMaps = () => {
    if (currentLocation) {
      emergencyService.openLocationInMaps(
        ...
        >
          ...
          <View className="mb-6">
            ...
            <Text className="text-lg text-gray-500 mb-4">
              This will notify all your emergency contacts and doctors with your
              current location and that you need immediate assistance.
            </Text>
            ...
            {!locationPermissionGranted && (
              <View className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mt-3">
                ...
                <Text className="text-yellow-700 mt-1">
                  Enable location services for emergency alerts to include your
                  precise location.
                </Text>
              </View>
            )}
            ...
            {loading ? (
              ...
              <View className="bg-white rounded-xl p-6 mb-3 shadow-sm">
                ...
                <Text className="text-gray-400 text-center mt-1">
                  Tap the Add button to create your first contact
                </Text>
              </View>
            ) : (
          ...
          <View className="mb-6">
            ...
            <View className="bg-white rounded-xl p-4 mb-4 shadow-sm">
              ...
              <View className="pl-2">
                <View className="flex-row items-center mb-2">
                  ...
                  <Text className="text-lg text-gray-800 ml-2 flex-1">
                    Time the seizure
                  </Text>
                </View>
                <View className="flex-row items-center mb-2">
                ...
                <View className="flex-row items-center mb-2">
                  <Ionicons name="checkmark" size={20} color="#27AE60" />
                  <Text className="text-lg text-gray-800 ml-2 flex-1">
                    Reassure them when they recover
                  </Text>
                </View>
              </View>
            </View>
            ...
            <View className="bg-white rounded-xl p-4 mb-4 shadow-sm">
              <View className="flex-row items-center mb-3">
                ...
                <Text className="text-xl font-bold text-red-500 ml-2">
                  DON'T
                </Text>
              </View>
              <View className="pl-2">
                ...
                <View className="flex-row items-center mb-2">
                  <Ionicons name="close" size={20} color="#E74C3C" />
                  <Text className="text-lg text-gray-800 ml-2 flex-1">
                    Give them food or drink until fully recovered
                  </Text>
                </View>
              </View>
            </View>
